...
namespace ChatMessenger.Server.Interfaces.Services
{
    ...
    public interface IChatService
    {
        ...
        /// </summary>
        /// <remarks>
        /// 채팅방 접근 권한이 있는지 확인하고,<br/>
        /// RepositoryService를 통해 Response 생성에 필요한 DTO를 추출한 뒤, Response로 매핑해 반환합니다.
        /// </remarks>
        ...
        /// <returns>요청 결과 Data가 담긴 ServiceResult</returns>
        Task<ServiceResult<Guid>> CreateChatRoomAsync(string myEmail, CreateGroupChatRequest request);
        #endregion 채팅방 Search, Add, Remove, Update
        #region 채팅 참가자 Search, Add, Remove, Update
        /// <summary>
        /// 채팅방의 참가자들의 ParticipantDTO를 가져옵니다.
        /// </summary>
        /// <param name="roomId">채팅방 식별 번호</param>
        /// <returns>요청 결과 Data가 담긴 ServiceResult</returns>
        Task<ServiceResult<List<ChatParticipantDTO>>> GetParticipantDTOListAsync(Guid roomId);
        ...
        /// <returns>참가자 등록 성공 시 초대 SystemMessage 반환</returns>
